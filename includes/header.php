            ...
            <div class="flexslider basicslider">
                <ul class="slides">
                    <li>
                        <article>
                            <p>STB Bank</p>
                            <h3 class="heading">Bienvenue sur STB Bank</h3>
                            <p>Bienvenue à la banque en ligne de la Société Tunisienne de Banque</p>
                            <footer><a class="btn btn-warning" href="connection.php">Se connecter</a></footer>
                        </article>
                    </li>
                    <li>
                        <article>
                            <li class="active">STB Bank </li>
                            <h3 class="heading">Bienvenue sur STB Bank</h3>
                            <p>vous n'avez pas de compte ? S'inscrire maintenant </p>
                            <footer><a class="btn btn-warning" href="inscription.php">S'inscrire</a></footer>
                        </article>
                    </li>
                    <li>
                        <article>
                            <p>STB Bank</p>
                            <h3 class="heading">Bienvenue sur STB Bank</h3>
                            <p>Besoin d'aide sur un service, un produit ou une offre UIB? Nos conseillers sont disponibles pour répondre à vos questions et vous guider dans vos choix.</p>
                            <footer><a class="btn btn-warning" href="contact.php">Tapez ici</a></footer>
                        </article>
                    </li>
                </ul>
            </div>
